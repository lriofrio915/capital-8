    ...
    <div className={cn("section", styles.section)}>
      <div className={cn("container", styles.container)}>
        <div className={styles.line}>
          <h2 className={cn("h2", styles.title)}>Mercado</h2>
          <Link className={cn("button-stroke", styles.button)} href="/market">
            Ver más
          </Link>
        </div>
        ...
        <div className={styles.table}>
          <div className={styles.row}>
            ...
            <div className={styles.col}>Precio</div>
            <div className={styles.col}>Cambio 24h</div>
            <div className={styles.col}>Gráfico</div>
            <div className={styles.col}>Negociar</div>
          </div>
          {items.map((x, index) => (
